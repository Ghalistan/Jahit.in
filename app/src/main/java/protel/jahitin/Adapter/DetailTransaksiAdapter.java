...
public class DetailTransaksiAdapter extends RecyclerView.Adapter<DetailTransaksiAdapter.DetailVH> {
    ...
    private List<Integer> listHarga;

    public DetailTransaksiAdapter(Context mContext, List<Pakaian> listPakaian, List<Integer> listHarga) {
    ...
    public void onBindViewHolder(@NonNull DetailVH holder, int position) {
        ...
        holder.harga.setText(listHarga.get(position));
